                        ...
                        <form action="{{ route('admin.tour.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('jadwal_mulai') is-invalid @enderror"
                                    id="jadwal_mulai" name="jadwal_mulai" value="{{ old('jadwal_mulai') }}">
                                @error('jadwal_mulai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('jadwal_selesai') is-invalid @enderror"
                                    id="jadwal_selesai" name="jadwal_selesai" value="{{ old('jadwal_selesai') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="summernote" name="deskripsi">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3" id="alamat-container"
